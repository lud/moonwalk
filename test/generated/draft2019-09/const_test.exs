...
defmodule Elixir.Moonwalk.Generated.Draft201909.ConstTest do
  alias Moonwalk.Test.JsonSchemaSuite
  use ExUnit.Case, async: true

  @moduledoc """
  Test generated from deps/json_schema_test_suite/tests/draft2019-09/const.json
  """

  describe "const validation:" do
    setup do
      json_schema = %{"$schema" => "https://json-schema.org/draft/2019-09/schema", "const" => 2}
  ...
  describe "const with null:" do
    setup do
      json_schema = %{"$schema" => "https://json-schema.org/draft/2019-09/schema", "const" => nil}
      schema = JsonSchemaSuite.build_schema(json_schema, [])
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "const with false does not match 0:" do
    setup do
      json_schema = %{"$schema" => "https://json-schema.org/draft/2019-09/schema", "const" => false}
      schema = JsonSchemaSuite.build_schema(json_schema, [])
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "const with true does not match 1:" do
    setup do
      json_schema = %{"$schema" => "https://json-schema.org/draft/2019-09/schema", "const" => true}
      schema = JsonSchemaSuite.build_schema(json_schema, [])
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "const with 0 does not match other zero-like types:" do
    setup do
      json_schema = %{"$schema" => "https://json-schema.org/draft/2019-09/schema", "const" => 0}
      schema = JsonSchemaSuite.build_schema(json_schema, [])
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "const with 1 does not match true:" do
    setup do
      json_schema = %{"$schema" => "https://json-schema.org/draft/2019-09/schema", "const" => 1}
      schema = JsonSchemaSuite.build_schema(json_schema, [])
      {:ok, json_schema: json_schema, schema: schema}
    end
  ...
  describe "const with -2.0 matches integer and float types:" do
    setup do
      json_schema = %{"$schema" => "https://json-schema.org/draft/2019-09/schema", "const" => -2.0}
      schema = JsonSchemaSuite.build_schema(json_schema, [])
      {:ok, json_schema: json_schema, schema: schema}
    end
