...
defmodule Elixir.Moonwalk.Generated.Draft201909.BooleanSchemaTest do
  alias Moonwalk.Test.JsonSchemaSuite
  use ExUnit.Case, async: true

  @moduledoc """
  Test generated from deps/json_schema_test_suite/tests/draft2019-09/boolean_schema.json
  """
