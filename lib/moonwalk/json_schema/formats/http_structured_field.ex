...
defmodule Moonwalk.JsonSchema.Formats.HttpStructuredField.Parser do
  @moduledoc false
...
defmodule Moonwalk.JsonSchema.Formats.HttpStructuredField do
  alias Moonwalk.JsonSchema.Formats.HttpStructuredField.Parser

  @moduledoc """
  HTTP Structured Field parser implementation following RFC 8941.

  Uniqueness of keys and dictionaries is not enforced.
  """
