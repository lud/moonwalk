defmodule Moonwalk.OldSchema.Context do
  @moduledoc false
  defstruct [
...
defmodule Moonwalk.OldSchema do
  alias Moonwalk.OldSchema.Context
  ...
  defdelegate validate(data, schema), to: Moonwalk.OldSchema.Validator
end
